...
has_many :oauth_profiles
  ...
  devise  :database_authenticatable, :token_authenticatable, :oauthable, :recoverable, :registerable, :rememberable, :trackable, :validatable

  # Setup accessible (or protected) attributes for your model
attr_accessible :username
attr_accessible :default_provider
